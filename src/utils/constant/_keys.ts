export const KEYS = {
  ...
  PROJECT_DETAIL_EMPLOYEE: 'project-employee',
  PROJECT_PAGINATION: 'project-pagination',
  PROJECT_TOTAL: 'project-total',
  PROJECT_LABEL: 'project-label',
  PROJECT_LABEL_DETAIL: 'project-label-detail',
  ...
  SUPPLIER_LABEL_DETAIL: 'supplier-label-detail',
