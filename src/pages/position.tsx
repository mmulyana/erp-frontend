...
import CardStatusEmployee from '@/features/hris/employee/component/card-status-employee'
import CardTotalEmployee from '@/features/hris/employee/component/card-total-employee'
import ModalDelete from '@/features/hris/employee/component/delete-position'
import ModalAdd from '@/features/hris/employee/component/add-position'
import { DashboardLayout } from '@/shared/component/layout'
import { steps } from '@/features/hris/employee/component/tour-index'
...
export default function Employee() {
	...
	return (
		<DashboardLayout>
			...
			<Tour steps={steps} name='position' />
		</DashboardLayout>
	)
}
