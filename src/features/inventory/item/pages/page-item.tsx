...
export default function PageItem({ type }: { type?: string }) {
	...
	const subtitle = {
		material: 'Kelola data material',
		tool: 'Kelola data alat proyek',
	}

	return (
		<DefaultLayout className='space-y-6' module='inventory'>
			<ItemAvailability variant='compact' type={type} />
