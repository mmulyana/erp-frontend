			...
			cell: ({ row }) => {
				...
				return (
					<div
						...
						id={`${testIds.dropdownEditEmployee}-${row.index + 1}`}
						data-testid={`${testIds.dropdownEditEmployee}-${row.index + 1}`}
					>
		...
		<>
			<HeadTable>
				...
				<div className='flex gap-2 items-center'>
					<div
						id={testIds.buttonOpenCompetency}
						data-testid={testIds.buttonOpenCompetency}
					>
						<Button
							variant='secondary'
							className='w-8 p-0'
					...
					<ProtectedComponent required={['employee:create']}>
						<div
							id={testIds.buttonAddEmployee}
							data-testid={testIds.buttonAddEmployee}
						>
